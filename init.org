...
#+begin_src elisp :tangle "yes"
    (use-package erc
      ...
      (erc-nick "Ana" "ana") 
      (erc-nick-uniquifier "-{^-^}" "-{UwU}" "-{OwO}" "-{u,u}" "-{OvO}") ;; want it to be random !
      ...
      ;; ~visuals
      (erc-interactive-display 'bury) ;; when executing commands such as /JOIN, open in another buffer rather than window, we could also use 'buffer to have it open in our current buffer instead.
