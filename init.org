...
#+begin_src elisp :tangle "yes"
  (use-package lsp-bridge
    ...
    (lsp-bridge-cmake-lsp-server "cmake-language-server")
  	...
  	(lsp-bridge-enable-debug t) ;; to test
...
#+begin_src shell :tangle "no"
  git clone https://github.com/latex-lsp/texlab.git ~/.cache/texlab # could be another dest but this is a practical one.
    ...
    cargo build --release # Remove the --release for a debug build.
  	# Add it to path by modifying .bashrc or .profile or smth, it'd look like : export PATH=$PATH:~/.cache/texlab/target/release
#+end_src
*** OCAML !
**** Opam !
#+begin_src elisp :tangle "yes"
...
#+begin_src elisp :tangle "no"
  (use-package PG
  	:ensure (PG :host github :repo "ProofGeneral/PG"))
#+end_src
*** Lolcode !
#+begin_src elisp :tangle "yes"
...
#+begin_src elisp :tangle "yes"
  (use-package emacs-gradle-mode
  	:ensure (emacs-gradle-mode :host github :repo "scubacabra/emacs-gradle-mode"))
#+end_src
**** JDTLS
